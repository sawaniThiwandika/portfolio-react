    ...
    return (
        <section id="tech" className="mt-20 py-16 px-6 w-5/6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8">
                ...
                <div className={`text-center p-6 rounded-2xl shadow-lg border ${darkMode ? 'border-gray-600' : 'border-gray-300'} hover:scale-105 transition-transform duration-300`}>
                    <h3 className={`text-2xl font-semibold ${darkMode ? 'text-purple-300' : 'text-purple-700'} text-center flex justify-center space-x-2`}>
                        <span>Languages</span>
                    </h3>
